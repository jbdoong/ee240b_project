...
yaml_file = pkg_resources.resource_filename(__name__, os.path.join('netlist_info', 'ph3_sa_tb.yaml'))


# noinspection PyPep8Naming
class project__ph3_sa_tb(Module):
    """Module for library project cell ph3_sa_tb.
